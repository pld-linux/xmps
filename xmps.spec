...
Summary(pl):	Odtwarzacz plikÛw MPEG dla X
Name:		xmps
Version:	0.2.0
Release:	5
License:	GPL
...
prostym programem wykorzystuj±cym Gtk ktÛry (miejmy nadziejÍ) odtwarza
pliki MPEG z obrazem i dºwiÍkiem pod Linuksem.

%package devel
Summary:	xmps - header files
Summary(pl):	xmps - pliki nag≥Ûwkowe
...
Pliki nag≥Ûwkowe wymagane do budowania wtyczek xmps.
